  ...
  const SearchDropdown = () => {
    return (
      <motion.div
        ...
        exit={{ opacity: 0, y: -10 }}
        className="bg-white rounded-[16px] shadow-lg p-6 max-h-[700px] overflow-y-auto overflow-x-hidden"
      >
        <div className="">
          {searchSuggestions.map((suggestion, index) => (
            ...
            >
              ...
              <img src={searchGray} alt="JBL Logo" className="w-4 h-4" />
          ...
          <div className="flex gap-4 pb-4">
            {products.map((product) => (
              ...
              >
                ...
                <div className=" mb-2 text-[12px] font-semibold leading-[16px]">
                  <span className="text-[#291ABD] ">NOTEBOOK</span>{" "}
        ...
        <div className="mt-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex gap-1 flex-1 font-[600] text-[14px]">
                <span className="text-[#291ABD] ">Notebook</span>
                <span className="text-[#646464] uppercase">CPU AMD</span>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-20 gap-6">
            ...
            {/* Centered group of Logo, Search, and Icons */}
            <div className="flex flex-1 justify-center items-center gap-4">
              {/* Logo */}
              <div className="text-3xl font-bold tracking-wider flex-shrink-0">
              ...
              <div className="w-full max-w-[1080px]">
                <div className="relative flex-1">
                  ...
                  {/* Search Dropdown positioned absolutely below the search bar */}
                  <AnimatePresence>
                    {showDropdown && (
              ...
              <div className="flex items-center space-x-6">
                <div className="relative">
                  ...
                  <span className="absolute top-[23px] -right-2 bg-[#FDAF17] text-white text-[10px] rounded-full px-[5px] flex items-center justify-center">
                    99+
                  </span>
                </div>
                <div className="relative">
                  <img src={shoppingCart} alt="cart" className="w-12 h-12" />
                  <span className="absolute top-[23px] -right-2 bg-[#FDAF17] text-white text-[10px] rounded-full px-[5px] flex items-center justify-center">
                    99+
                  </span>
                </div>
      ...
      <main className="container mx-auto p-8">
        ...
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          ...
          <p className="text-gray-600 mt-2">
            Click on the search bar to see the dropdown.
          </p>
        </div>
      </main>
    </div>
